...
const MenuSellerFlatlist = ({ newItem, sortItem, fontstyles, navigation, setOpenDropdowns, openDropdowns, handleChanges }) => {
        ...
        >
                ...
                <View key={`${categoryIndex}`} style={{ marginBottom: 20 }}>
                    {category.items.map((item, index) => (
                        <View key={`${item.item}_${index}`}>
                            ...
                            {dropDown(index, fontstyles, item, navigation, setOpenDropdowns, openDropdowns, handleChanges)}
                        </View>
                    ))}
                </View>
            ))}
            ...
            >
                ...
                <View style={{ marginTop: 20 }}>
                    <View style={{ height: 1, backgroundColor: Colors.dark.colors.textColor }} />
                    ...
                    <View style={{ height: 1, backgroundColor: Colors.dark.colors.textColor, marginVertical: 1 }} />
                </View>
...
export default MenuSellerFlatlist;
