...
const Icons = () => {
    ...
    const StarIcon = () => {
            return (
                <View className={`rounded-full flex-row justify-center items-center bg-[#00e676]`} style={{ width: Dimensions.get('window').height * 0.025, height: Dimensions.get('window').height * 0.025 }}>
                    <Ionicons style={{ paddingBottom: 2 }} name="star" size={13} color={Colors.dark.colors.mainTextColor} />
                </View>
            )
        }
        ...
        function CarIcon() {
            return (
                <View className={`rounded-full flex-row justify-center items-center`} style={{ backgroundColor:Colors.dark.colors.diffrentColorPerple, width: Dimensions.get('window').height * 0.03, height: Dimensions.get('window').height * 0.03 }}>
                    <Ionicons name="footsteps" size={15} color={Colors.dark.colors.mainTextColor} />
                </View>
            )
        }
