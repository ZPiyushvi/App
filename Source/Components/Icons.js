...
const Icons = () => {
    ...
    const StarIcon = () => {
        ...
        function CarIcon() {
            return (
                <View className={`rounded-full flex-row justify-center items-center`} style={{ backgroundColor:Colors.dark.colors.diffrentColorOrange, width: Dimensions.get('window').height * 0.03, height: Dimensions.get('window').height * 0.03 }}>
