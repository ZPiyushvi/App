...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, ScrollView, KeyboardAvoidingView, Platform, StatusBar, Dimensions, FlatList } from 'react-native';
...
export default function Like({ navigation }) {
    ...
    const [editingOutlet, setEditingOutlet] = useState(null); // To keep track of the outlet being edited
        ...
        <ScrollView style={styles.container}>
            {editingOutlet && (
                <>
                    ...
                    <TouchableOpacity onPress={handleSaveOutlet} style={styles.addButton}>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={styles.outletItem}>
                        ...
                        <TouchableOpacity onPress={() => handleEditOutlet(item)} style={styles.editButton}>
