...
const colors = [
  {
    initialBgColor: Colors.dark.colors.componentColor, //'goldenrod',
    bgColor: Colors.dark.colors.componentColor, //'#222',
    nextBgColor: Colors.dark.colors.diffrentColorOrange, //'#222',
  },
  {
    initialBgColor: Colors.dark.colors.componentColor, //'goldenrod',
    bgColor: Colors.dark.colors.diffrentColorOrange, //'#222',
    nextBgColor: Colors.dark.colors.secComponentColor, //'yellowgreen',
  },
  {
    initialBgColor: Colors.dark.colors.backGroundColor, //'#222',
    bgColor: Colors.dark.colors.secComponentColor, //'yellowgreen',
    nextBgColor: Colors.dark.colors.backGroundColor, //'midnightblue',
  },
  // {
