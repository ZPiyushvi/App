  ...
  return (
    <View className='p-4 pt-8 h-full' style={{ backgroundColor: Colors.dark.colors.backGroundColor }}>
      <View className=' h-full justify-center'>
        <Text style={{
          fontFamily: fontFamilies.none === 'no' ? undefined : fontFamilies.bold,
          fontWeight: fontFamilies.none === 'no' ? '900' : undefined, fontSize: Size.size.headerText, color: Colors.dark.colors.mainTextColor, lineHeight: 45
        }}>Why Are</Text>
        <Text style={{ fontFamily: fontFamilies.bold, fontSize: Size.size.headerText, color: Colors.dark.colors.diffrentColorOrange, lineHeight: 45 }}>You</Text>
        <Text className=' py-10' style={{ fontFamily: fontFamilies.medium, fontSize: Size.size.mediumText, color: Colors.dark.colors.textColor }}>
        ...
        <View className=' mt-10'>
          ...
          >
            <Text style={{ fontFamily: fontFamilies.bold, fontSize: Size.size.largeText, color: userRole === 'Buyer' ? Colors.dark.colors.mainTextColor : Colors.dark.colors.textColor }}>Buyer</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className='inputContainer mt-5 flex-row items-center justify-center px-4 h-14 border-solid border-2 rounded-full'
          ...
          >
            <Text style={{ fontFamily: fontFamilies.bold, fontSize: Size.size.largeText, color: userRole === 'Seller' ? Colors.dark.colors.mainTextColor : Colors.dark.colors.textColor }}>Seller</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={{ fontFamily: fontFamilies.bold, fontSize: Size.size.largeText, color: Colors.dark.colors.mainTextColor }}>Procced</Text>
          </TouchableOpacity>
        </View>
      </View>
    </View>
